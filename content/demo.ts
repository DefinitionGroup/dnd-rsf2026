...
const clariseaPage = page({
  ...
  content: [
    heroDemo({
      ...
      image: "original/clarisea-sk5000-rolls.png",
      imageAlt: "ClariSea SK-5000 Gen 3 automatic fleece filter with two XL QuickChange fleece rolls",
    ...
    galleryDemo({
      ...
      headline: "Up close.",
      images: [
        { file: "original/clarisea-sk3000.jpg", alt: "ClariSea SK-3000 Gen 3", caption: "SK-3000 G3" },
        ...
        { file: "original/clarisea-packaging.jpg", alt: "ClariSea Gen 3 packaging", caption: "Gen 3 packaging" },
