...
export const spektrum150: ProductSummary = {
  ...
  category: "Lighting",
  sku: "SPK-150",
  image: img("spektrum-150.jpg"),
  imageAlt: "Spektrum 150 reef LED light",
  gallery: [
...
export const funktionPump: ProductSummary = {
  ...
  category: "Pumps",
  sku: "FRP",
  image: img("funktion-pump.jpg"),
  imageAlt: "Funktion Return Pump with controller",
  gallery: [
